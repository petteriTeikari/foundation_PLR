...
from src.classification.tabpfn.model.layer import PerFeatureEncoderLayer
...
class PerFeatureTransformer(nn.Module):
    ...
    def __init__(  # noqa: C901, D417, PLR0913
        ...
        **layer_kwargs: Any,
        ...
        layer_creator = lambda: PerFeatureEncoderLayer(  # noqa E731
            d_model=ninp,
            nhead=nhead,
        ...
        if repeat_same_layer:
            layer = layer_creator()
            layer_creator = lambda: layer  # noqa E731
