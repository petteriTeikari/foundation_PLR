...
from src.classification.tabpfn_v1.layer import TransformerEncoderLayer
from src.classification.tabpfn_v1.utils import SeqBN, bool_mask_to_att_mask
...
class TransformerModel(nn.Module):
    def __init__(
        ...
        encoder_layer_creator = lambda: TransformerEncoderLayer(  # noqa E731
            ninp,
            nhead,
            nhid,
            dropout,
