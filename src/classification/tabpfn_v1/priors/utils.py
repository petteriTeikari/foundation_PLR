...
from src.classification.tabpfn_v1.utils import set_locals_in_self
...
uniform_int_sampler_f = lambda a, b: lambda: round(np.random.uniform(a, b))  # noqa: E731
