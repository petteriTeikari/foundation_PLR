...
def draw_missingrate():
    ...
    pred_list = [
        [NuwaTS_01, PatchTST_01, GPT4TS_01, TimesNet_01, BRITS_01],
        ...
        for i, value in enumerate(time_serie):
            ...
            if start_index is not None and mask[i] == 0:
                ...
                plt.plot(
                    ...
                    time_serie[start_index:end_index],
                    linewidth=5,
                    color="black",
                    linestyle="-",
                )
            ...
            if masked_start_index is not None and mask[i] == 1:
                ...
                plt.plot(
                    range(masked_start_index, masked_end_index),
                    time_serie[masked_start_index:masked_end_index],
                    linewidth=5,
                    color="black",
                    linestyle=":",
                )
