...
if __name__ == "__main__":
    ...
    if (
        args.model == "PatchTST"
        or args.model == "Autoformer"
        or args.model == "DLinear"
        or args.model == "iTransformer"
        or args.model == "FEDformer"
    ):
        raise NotImplementedError("PatchTST experiment not implemented")
        # Exp = Exp_Imputation_PatchTST
    else:
        if args.is_forecasting:
            raise NotImplementedError("Forecasting not implemented")
            # Exp = Exp_forecasting
        else:
            Exp = Exp_Imputation
