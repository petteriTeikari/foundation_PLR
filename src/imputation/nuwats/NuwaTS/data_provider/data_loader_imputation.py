...
from src.imputation.nuwats.NuwaTS.utils.timefeatures import time_features
from src.imputation.nuwats.NuwaTS.data_provider.m4 import M4Dataset, M4Meta
...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        self.test_sensors = sensor_columns[
            2 * num_sensors_per_set : 3 * num_sensors_per_set
        ]
